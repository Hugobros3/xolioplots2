...
public class PlotsCommandHandler implements CommandHandler {
	...
	public boolean handleCommand(CommandEmitter emitter, Command command, String[] arguments) {
		...
		if(wg.getClass().getSimpleName().equals("PlotsWorldGenerator")) {
			...
			int x = (int)(double)loc.getX();
			int z = (int)(double)loc.getZ();
	...
	private Player getPlayer(String string) {
		...
		if(plugin.getPluginExecutionContext() instanceof ServerInterface)
			return ((ServerInterface)plugin.getPluginExecutionContext()).getPlayerByName(string);
